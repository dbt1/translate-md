...
- [Translate-MD: Markdown Übersetzungsskript](#translate-md-markdown-translation-script)
  - [Inhaltsverzeichnis](#table-of-contents)
  - [Funktionen](#features)
  - [Installation](#installation)
    - [Abhängigkeiten installieren](#install-dependencies)
    - [Überprüfung der Abhängigkeiten](#dependency-checking)
    - [Option 1: Installation und Ausführung in einer virtuellen Umgebung (empfohlen)](#option-1-install-and-run-in-a-virtual-environment-recommended)
    - [Option 2: Systemweite Installation](#option-2-system-wide-installation)
    - [Alternative Installation von googletrans vom GitHub-Repository (nicht empfohlen)](#alternative-installation-of-googletrans-from-github-repository-not-recommended)
  - [Verwendung](#use)
    - [Zusammenfassung der Parameter](#summary-of-parameters)
    - [1. Standardverwendung mit den Standardparametern](#1-standard-use-with-the-standard-parameters)
    - [2. Angabe einer spezifischen Template-Datei und eines Ausgabeverzeichnisses](#2-specifying-a-specific-template-file-and-an-output-directory)
    - [3. Festlegen eines benutzerdefinierten Dateipräfixes und Namens für das Hauptdokument](#3-set-a-custom-file-prefix-and-name-for-the-main-document)
    - [4. Verwendung einer Konfigurationsdatei](#4-using-a-configuration-file)
    - [5. Kombination von Kommandozeilenparametern und Konfigurationsdatei](#5-combination-of-command-line-parameters-and-configuration-file)
    - [6. Verwendung der Option zum Deaktivieren von Sprachlinks](#6-using-the-option-to-disable-voice-links)
    - [7. Kombinierte Verwendung aller Optionen](#7-combined-use-of-all-options)
    - [8. Anzeigen der Versionsinformation](#8-view-version-information)
    - [9. Hilfe anzeigen](#9-show-help)
    - [10. Beispiel mit deaktivierten Sprachlinks und Verwendung eines anderen Präfixes](#10-example-with-language-links-disabled-and-using-a-different-prefix)
    - [11. Verwendung der Kurzform der Optionen](#11-use-of-the-short-form-of-options)
  - [Beispiel für GitHub Actions Integration](#example-of-github-actions-integration)
